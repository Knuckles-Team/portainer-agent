##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/GetKubernetesServiceAccounts)Get a list of kubernetes service accounts
...
https://api-docs.portainer.io/api/kubernetes/{id}/serviceaccounts
###  Response samples
  * 200
