##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/deleteKubernetesNamespacedCustomResource)Delete a namespaced kubernetes Custom Resource
...
---|---
namespacerequired |  string The namespace name to delete the custom resource from
...
delete/kubernetes/{id}/customresources/{namespace}/{name}
