##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/getKubernetesClusterScopedCustomResource)Get a cluster-scoped kubernetes Custom Resource
...
get/kubernetes/{id}/customresources/{name}
