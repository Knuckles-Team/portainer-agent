##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/UpdateKubernetesIngressControllersByNamespace)Update (block/unblock) ingress controllers by namespace
