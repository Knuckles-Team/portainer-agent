##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/DeleteJobs)Delete Jobs
...
post/kubernetes/{id}/jobs/delete
https://api-docs.portainer.io/api/kubernetes/{id}/jobs/delete
###  Request samples
  * Payload
