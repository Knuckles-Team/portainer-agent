##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/DeleteRoles)Delete roles
...
post/kubernetes/{id}/roles/delete
https://api-docs.portainer.io/api/kubernetes/{id}/roles/delete
###  Request samples
  * Payload
