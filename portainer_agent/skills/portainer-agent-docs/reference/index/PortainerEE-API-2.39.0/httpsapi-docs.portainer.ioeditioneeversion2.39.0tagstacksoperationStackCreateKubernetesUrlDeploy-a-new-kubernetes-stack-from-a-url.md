##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/stacks/operation/StackCreateKubernetesUrl)Deploy a new kubernetes stack from a url
...
https://api-docs.portainer.io/api/stacks/create/kubernetes/url
###  Request samples
  * Payload
