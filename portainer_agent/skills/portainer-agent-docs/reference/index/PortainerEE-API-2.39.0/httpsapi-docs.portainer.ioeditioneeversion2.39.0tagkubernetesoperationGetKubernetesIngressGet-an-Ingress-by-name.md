##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/GetKubernetesIngress)Get an Ingress by name
...
ingressrequired |  string Ingress name
### Responses
**200**
Success
**400**
...
https://api-docs.portainer.io/api/kubernetes/{id}/namespaces/{namespace}/ingresses/{ingress}
###  Response samples
  * 200
