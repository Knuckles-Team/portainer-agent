##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/GetKubernetesMetricsForAllPods)Get a list of pods with their live metrics
...
https://api-docs.portainer.io/api/kubernetes/{id}/metrics/pods/{namespace}
###  Response samples
  * 200
