##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/GetAllKubernetesServicesCount)Get services count
...
get/kubernetes/{id}/services/count
https://api-docs.portainer.io/api/kubernetes/{id}/services/count
###  Response samples
  * 200
