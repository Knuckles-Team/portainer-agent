##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/GetAllKubernetesClusterRoles)Get a list of kubernetes cluster roles
...
get/kubernetes/{id}/clusterroles
https://api-docs.portainer.io/api/kubernetes/{id}/clusterroles
###  Response samples
  * 200
