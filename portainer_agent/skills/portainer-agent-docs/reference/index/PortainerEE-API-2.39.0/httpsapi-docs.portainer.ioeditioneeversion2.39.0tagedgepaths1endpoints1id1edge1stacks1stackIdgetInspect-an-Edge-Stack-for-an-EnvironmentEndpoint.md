##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/edge/paths/~1endpoints~1{id}~1edge~1stacks~1{stackId}/get)Inspect an Edge Stack for an Environment(Endpoint)
