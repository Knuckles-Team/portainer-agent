##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/GetKubernetesNamespacesCount)Get the total number of kubernetes namespaces within the given Portainer environment.
...
get/kubernetes/{id}/namespaces/count
https://api-docs.portainer.io/api/kubernetes/{id}/namespaces/count
###  Response samples
  * 200
