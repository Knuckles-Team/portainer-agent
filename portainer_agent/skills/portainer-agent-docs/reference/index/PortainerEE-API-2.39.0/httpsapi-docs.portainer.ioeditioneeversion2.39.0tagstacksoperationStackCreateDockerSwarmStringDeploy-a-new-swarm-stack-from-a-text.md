##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/stacks/operation/StackCreateDockerSwarmString)Deploy a new swarm stack from a text
...
https://api-docs.portainer.io/api/stacks/create/swarm/string
###  Request samples
  * Payload
