##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kaas/operation/provisionClusterGKE)Provision a new Google Kubernetes (GKE) cluster and create an environment
...
post/cloud/gke/provision
https://api-docs.portainer.io/api/cloud/gke/provision
###  Request samples
  * Payload
