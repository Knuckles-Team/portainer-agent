##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/stacks/operation/StackCreateDockerSwarmRepository)Deploy a new swarm stack from a git repository
...
FilesystemPath |  string Network filesystem path
...
https://api-docs.portainer.io/api/stacks/create/swarm/repository
###  Request samples
  * Payload
