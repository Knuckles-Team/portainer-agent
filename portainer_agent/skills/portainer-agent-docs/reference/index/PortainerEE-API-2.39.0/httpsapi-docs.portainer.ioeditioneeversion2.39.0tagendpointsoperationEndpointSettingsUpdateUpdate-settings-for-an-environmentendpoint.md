##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/endpoints/operation/EndpointSettingsUpdate)Update settings for an environment(endpoint)
...
gpus |  Array of objects (portainer.Pair)
securitySettings |  object Security settings updates
### Responses
**200**
Success
**400**
...
https://api-docs.portainer.io/api/endpoints/{id}/settings
###  Request samples
  * Payload
