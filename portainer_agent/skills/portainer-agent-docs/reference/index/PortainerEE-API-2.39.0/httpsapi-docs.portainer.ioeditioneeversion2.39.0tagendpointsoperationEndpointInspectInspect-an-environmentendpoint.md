##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/endpoints/operation/EndpointInspect)Inspect an environment(endpoint)
...
---|---
##### query Parameters
excludeSnapshot |  boolean if true, the snapshot data won't be retrieved
---|---
### Responses
**200**
Success
