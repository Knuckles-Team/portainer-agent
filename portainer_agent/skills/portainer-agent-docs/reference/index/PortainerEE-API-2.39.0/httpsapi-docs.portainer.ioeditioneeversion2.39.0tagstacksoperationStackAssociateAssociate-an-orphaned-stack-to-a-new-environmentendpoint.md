##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/stacks/operation/StackAssociate)Associate an orphaned stack to a new environment(endpoint)
...
---|---
swarmIdrequired |  integer Swarm identifier
orphanedRunningrequired |  boolean Indicates whether the stack is orphaned
### Responses
**200**
Success
**400**
...
https://api-docs.portainer.io/api/stacks/{id}/associate
###  Response samples
  * 200
