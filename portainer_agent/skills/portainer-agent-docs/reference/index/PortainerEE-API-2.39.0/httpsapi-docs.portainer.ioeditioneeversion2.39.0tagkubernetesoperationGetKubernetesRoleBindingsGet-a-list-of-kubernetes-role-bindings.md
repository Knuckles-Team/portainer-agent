##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/GetKubernetesRoleBindings)Get a list of kubernetes role bindings
...
https://api-docs.portainer.io/api/kubernetes/{id}/rolebindings
###  Response samples
  * 200
