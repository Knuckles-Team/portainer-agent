##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/custom_templates/operation/CustomTemplateCreateString)Create a custom template
...
https://api-docs.portainer.io/api/custom_templates/create/string
###  Request samples
  * Payload
