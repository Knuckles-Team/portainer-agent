##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/DeleteRoleBindings)Delete role bindings
...
post/kubernetes/{id}/role_bindings/delete
https://api-docs.portainer.io/api/kubernetes/{id}/role_bindings/delete
###  Request samples
  * Payload
