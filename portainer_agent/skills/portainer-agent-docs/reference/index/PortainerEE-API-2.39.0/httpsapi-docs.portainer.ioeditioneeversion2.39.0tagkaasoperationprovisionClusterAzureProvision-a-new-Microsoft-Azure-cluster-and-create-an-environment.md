##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kaas/operation/provisionClusterAzure)Provision a new Microsoft Azure cluster and create an environment
...
---|---
KubernetesVersionrequired |  string
Namerequired |  string
NetworkID |  string
NodeCountrequired |  integer
NodeSizerequired |  string
Regionrequired |  string
availabilityZones |  Array of strings
dnsPrefix |  string
meta |  object (types.EnvironmentMetadata)
poolName |  string
resourceGroup |  string Azure specific fields
...
post/cloud/azure/provision
https://api-docs.portainer.io/api/cloud/azure/provision
###  Request samples
  * Payload
