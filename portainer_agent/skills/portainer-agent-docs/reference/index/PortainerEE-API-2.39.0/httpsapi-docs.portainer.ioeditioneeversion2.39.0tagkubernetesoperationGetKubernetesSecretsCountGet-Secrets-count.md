##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/GetKubernetesSecretsCount)Get Secrets count
...
get/kubernetes/{id}/secrets/count
https://api-docs.portainer.io/api/kubernetes/{id}/secrets/count
###  Response samples
  * 200
