##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/kubernetes/operation/GetAllKubernetesConfigMapsCount)Get ConfigMaps count
...
get/kubernetes/{id}/configmaps/count
https://api-docs.portainer.io/api/kubernetes/{id}/configmaps/count
###  Response samples
  * 200
