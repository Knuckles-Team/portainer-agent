##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/stacks/operation/StackCreateDockerSwarmFile)Deploy a new swarm stack from a file
...
https://api-docs.portainer.io/api/stacks/create/swarm/file
###  Response samples
  * 200
