##  [](https://api-docs.portainer.io/?edition=ee&version=2.39.0#tag/endpoint_groups/operation/EndpointGroupAddEndpoint)Add an environment(endpoint) to an environment(endpoint) group
