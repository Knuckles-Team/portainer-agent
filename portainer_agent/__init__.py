...
OPTIONAL_MODULES = {
    "portainer_agent.agent_server": "agent",
    "portainer_agent.mcp_server": "mcp",
}
...
_MCP_AVAILABLE = OPTIONAL_MODULES.get("portainer_agent.mcp_server") in [
    m.__name__ for m in globals().values() if hasattr(m, "__name__")
]
_AGENT_AVAILABLE = "portainer_agent.agent_server" in globals()
