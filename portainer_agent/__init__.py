...
OPTIONAL_MODULES = {
    "portainer_agent.agent": "agent",
    "portainer_agent.mcp": "mcp",
}
...
_MCP_AVAILABLE = OPTIONAL_MODULES.get("portainer_agent.mcp") in [
    m.__name__ for m in globals().values() if hasattr(m, "__name__")
]
_AGENT_AVAILABLE = "portainer_agent.agent" in globals()
