...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/portainer-agent"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in portainer-agent
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in portainer-agent but are NOT registered "
